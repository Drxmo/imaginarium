    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-danger" id="btnDelteYes" href="<?php echo url("/sitios/sitios/borrar/") ?>">Yes</a>
...
<script>
    document.getElementById("editarId").onclick = function() {
    document.getElementById("edFormId").submit();
}
</script>
<script>
